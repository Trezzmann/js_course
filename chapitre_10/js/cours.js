...
req.open("POST", "http://127.0.0.1/javascript-web-srv/post_php.php");
...
ajaxPost("http://127.0.0.1/javascript-web-srv/post_php.php", commande,
    function (reponse) {
...
form.addEventListener("submit", function (e) {
    ...
    ajaxPost("http://127.0.0.1/javascript-web-srv/post_php.php", data, function () {});
});
...
ajaxPost("http://127.0.0.1/javascript-web-srv/post_json.php", film,
    function (reponse) {
